...
/**
 * Question 1:
 * When, button 1 is clicked, select all paragraph elments on the page, and changed the color to blue.
 ...
 * Change the content to read "True Fact".
 */
...
/**
 * Question 7:
 * When button 3 is clicked, change the text in the header's h1 tag to read "Javascript Ninja"
 */
 ...
 * document.getElementsByClassName('city')[0].src = "http://lorempixel.com/g/500/400/food";
 */
